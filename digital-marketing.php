      ...
      <div class="row">
         <div class="col-md-12 col-sm-12">
            <div class="intro-text center padding_half wow fadeInUp">
               ...
               <h2 class="whitecolor text-capitalize bottom45">Digital marketing solutions </h2>
   ...
   <div class="container">
        <div class="row">
            <div class="col-md-8 col-md-offset-2 col-sm-8 col-sm-offset-2">
                ...
                <h2 class="darkcolor bottom25">We share a passion in digital marketing</h2>
                </div>
            </div>
            <div class="col-md-2 col-sm-2"></div>
        </div>
        <?php include 'inc/service-digital-marketing.php'?>

   </div>
</section>
<br><br><br>
<div class="container">
<h2 class=" text-capitalize bottom45" style="text-align:center;">Introduce us to your project</h2>
